   ...
   cart.forEach(item => {
    ...
    cartItemElement.innerHTML = `
     <div class=" flex item-center justify-between ">
       ...
       <button class="remove-from-cart-btn text-red-500 font-medium" data-name="${item.name}">
         Remover
       </button>
     </div>
    `
...
checkoutBtn.addEventListener("click", function(){
    ...
    const phone = '48996385235'

    window.open(`https://wa.me/${phone}?text=${message}  Endereço da entrega: ${addressInput.value}`, '_blank');
